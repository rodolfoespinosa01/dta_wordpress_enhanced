    ...
    public function admin_scripts(): void
    {
        if ($this->utils->isThisPage('wp-admin/admin.php?page=hostinger-get-onboarding') || $this->utils->isThisPage('wp-admin/admin.php?page=' . Menus::MENU_SLUG)) {
            ...
            $localize_data = array(
                ...
                'plugin_assets_url'       => HOSTINGER_EASY_ONBOARDING_PLUGIN_URL,
                ...
                'translations'     => array(
                    ...
                    'hostinger_easy_onboarding_how_to_add_wordpress_website_to_google_search_console' => __('How to Add Your WordPress Website to Google SearchPages Console', 'hostinger-easy-onboarding'),
